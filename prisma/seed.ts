...
async function main() {
  ...
  const checklistItems = [
    ...
    { section: "business", title: "Open a business bank account", description: "Apply for a business checking account through Atlas. Your application is reviewed by our team and your account is set up by our backend office once your formation is complete.", url: "/portal/bank", urlLabel: "Apply for business banking", sortOrder: 3 },
